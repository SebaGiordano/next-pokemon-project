...
import { Button, Card, Container, Grid, Image, Popover, Spacer, Text, Pagination as UIPagination } from '@nextui-org/react';

import confetti from 'canvas-confetti';

import { Layout } from '../../components/layouts'
import { pokeApi } from '../../api'
import { getPokemonInfo, localFavorites, getPokemonAbility } from '../../utils';
...
const PokemonByNamePage = ({pokemon}) => {
    ...
    return (
        <Layout 
            title={"Pokemon " + pokemon.name.replace(/^\w/, (c) => c.toUpperCase())}
        >
                ...
                <Grid xs={12} sm={8}>
                    <Card style={{backgroundColor: '$gradient'}}>
                        ...
                        <Card.Body>
                            ...
                            <Spacer y={1} css={{height: "2px", width: '100%', margin: '10px auto !important', backgroundColor: '$blue500'}}/>
                            ...
                            <Grid.Container direction='row' justify='flex-start' gap={2}>
                                {pokemon.stats.map((stat) => (
                                    <Grid xs={4} key={stat.stat.name} justify='space-between'>
                                        ...
                                        <Text h4 transform='capitalize'>{stat.base_stat}</Text>
                                    </Grid>
                                ))}
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            <Swiper
                                ...
                                {imagenes.map(
                                    (imagen, index) => (
                                        <SwiperSlide key={index} style={{width: '100%', textAlign: 'center', background: 'transparent', display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '340px'}}>
